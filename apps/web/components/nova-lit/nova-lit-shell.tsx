...
const MENU_SECTIONS: NavSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: "War Room", href: "/operacao/war-room", icon: "operation" },
      { label: "Playbooks", href: "/operacao/playbooks", icon: "shield" },
      { label: "Relatório do turno", href: "/operacao/relatorio-turno", icon: "reports" },
      { label: "Evidências", href: "/operacao/evidencias", icon: "reports" },
      { label: "Pós-incidente", href: "/operacao/pos-incidente", icon: "reports" },
      { label: "Auditoria", href: "/operacao/auditoria-operacional", icon: "reports" },
      { label: "Comunicação", href: "/operacao/comunicacao-turno", icon: "reports" },
