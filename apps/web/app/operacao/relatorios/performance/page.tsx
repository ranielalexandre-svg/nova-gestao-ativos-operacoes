...
export default async function RelatorioPerformancePage() {
  ...
  if (!session.authenticated) redirect("/login?next=/operacao/relatorios/performance");
  ...
  return (
    <NovaLitShell activeHref="/operacao/relatorios/performance">
      <main className="nova-performance-page">
        <section className="nova-performance-hero">
          <div>
            <span>Relatórios NOC / Performance</span>
          ...
          <aside className="nova-performance-side">
            ...
            <section className="nova-performance-card">
              ...
              <div className="nova-performance-actions">
                ...
                <Link href="/operacao/relatorios/monitoramento" className="nds-button" data-variant="primary">Exportar relatório</Link>
              </div>
            </section>
          </aside>
        </section>
