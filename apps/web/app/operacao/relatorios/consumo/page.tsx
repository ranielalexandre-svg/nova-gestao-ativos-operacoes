...
function EmptyState({ label }: { label: string }) {
  return (
    <div className="nova-consumo-empty">
      <div>N</div>
      <strong>{label}</strong>
      <span>Gere um relatório no workspace operacional ou complete os metadados das unidades.</span>
    </div>
  );
}
...
export default async function RelatoriosConsumoPage() {
  ...
  if (!session.authenticated) redirect("/login?next=/operacao/relatorios/consumo");
  ...
  return (
    <NovaLitShell activeHref="/operacao/relatorios/consumo">
      <div className="nova-lit-page-heading nova-consumo-heading">
        <div>
          <h1>Relatórios NOC / Consumo</h1>
          <p className="nova-lit-page-subtitle">Biblioteca operacional de relatórios NOC, consumo de banda, metadados e exportações por unidade ou grupo.</p>
        </div>

        <div className="nova-lit-page-actions">
          <Link href="/operacao/relatorios/monitoramento?source=template" className="nova-lit-button nova-lit-button-secondary">Usar modelo</Link>
          <Link href="/operacao/relatorios/monitoramento" className="nova-lit-button nova-lit-button-primary">Novo relatório</Link>
        </div>
      </div>
      ...
      <section className="nova-consumo-main-grid">
          ...
          <section className="nova-lit-card nova-consumo-table-card">
            <div className="nova-consumo-section-title">
              ...
              <div>
                ...
                <Link href="/operacao/relatorios/monitoramento?source=template">Abrir templates</Link>
              </div>
            </div>
        ...
        <aside className="nova-consumo-right-col">
          <section className="nova-lit-card nova-consumo-preview">
            ...
            <Link href="/operacao/relatorios/monitoramento" className="nova-consumo-primary-action">Gerar relatório</Link>
          </section>
          ...
          <section className="nova-lit-card nova-consumo-quick">
            ...
            <Link href="/operacao/relatorios/monitoramento">Novo relatório <b>gerar</b></Link>
            <Link href="/operacao/relatorios/monitoramento?source=unit">Por unidade <b>{units.total}</b></Link>
            <Link href="/operacao/relatorios/monitoramento?source=template">Por template <b>{templates.length}</b></Link>
          </section>
