...
function buildFilterHref(query: FilterQuery) {
  ...
  return serialized ? `/operacao/relatorios/monitoramento?${serialized}` : "/operacao/relatorios/monitoramento";
}
...
export default async function MonitoringReportsPage({
  ...
  if (!session.authenticated) redirect("/login?next=/operacao/relatorios/monitoramento");
  ...
  return (
    <NovaLitShell activeHref="/operacao/relatorios/monitoramento">
      <div className="nova-monitoring-report-page nova-monitoring-report-lit-page grid gap-2">
        <PageHeader
          eyebrow="Operação / Relatórios NOC"
          ...
          actions={(
            <>
              ...
              <Link href="/operacao/relatorios/monitoramento" className="nds-button" data-variant="primary">
                Novo relatório
              </Link>
            </>
          )}
        ...
        <div className="nova-report-workbench">
          <div className="grid gap-2">
            <Surface>
              <form action="/operacao/relatorios/monitoramento" method="GET" className="grid gap-2">
          ...
          <aside className="grid gap-2 xl:sticky xl:top-3">
            ...
            <form id="monitoring-export-form" action="/operacao/relatorios/monitoramento/export-jobs" method="POST">
              ...
              <Surface>
                ...
                <div className="mt-2 grid gap-2">
                  <button
                    ...
                    name="format"
                    value="docx"
                    formAction="/operacao/relatorios/monitoramento/export"
                    formTarget="_blank"
