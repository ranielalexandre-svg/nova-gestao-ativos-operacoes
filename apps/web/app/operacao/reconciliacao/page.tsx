...
import { ReconciliationWorkspace } from "../../reconciliacao-central/reconciliation-workspace";
...
export default async function ReconciliacaoCentralPage() {
  ...
  if (!session.authenticated) {
    redirect("/login?next=/operacao/reconciliacao");
  }
  ...
  return (
    <NovaLitShell activeHref="/operacao/reconciliacao">
