...
export default async function AutomacaoPage({
  ...
  if (!session.authenticated) redirect("/login?next=/operacao/automacoes");
  ...
  const exportHref = withParams("/operacao/automacoes/export", currentParams, { page: undefined, pageSize: undefined });
  ...
  return (
    <NovaLitShell activeHref="/operacao/automacoes" hidePageHeader>
      <main className="nova-automation-workflow-page">
          <header className="nova-automation-workflow-heading">
            <div>
              <nav aria-label="Breadcrumb">
                ...
                <span>/</span>
                <Link href="/operacao/automacoes">Automações</Link>
                <span>/</span>
                <strong>Execução</strong>
              </nav>
              <h1>Automações do turno operacional</h1>
              <p>Orquestre regras, execuções, efeitos e falhas que alimentam fila, exceções e handoff do turno.</p>
            </div>
          </header>
          ...
          <section id="automation-rules" className="nova-automation-workflow-card nova-automation-workflow-rules-panel">
            ...
            <form id="automation-filters" action="/operacao/automacoes" className="nova-auto-filters">
              ...
              <Link href="/operacao/automacoes">Limpar</Link>
            </form>
          ...
          <section className="nova-auto-pagination nova-automation-workflow-pagination">
            ...
            <div>
              <Link
                href={withParams("/operacao/automacoes", currentParams, { page: Math.max(1, rulesResponse.meta.page - 1) })}
              ...
              <Link
                href={withParams("/operacao/automacoes", currentParams, { page: Math.min(rulesResponse.meta.totalPages, rulesResponse.meta.page + 1) })}
